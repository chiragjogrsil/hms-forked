...
const categorySections: CategorySection[] = [
  ...
  {
    id: "prescription-masters",
    title: "Prescription Masters",
    ...
    categories: [
      {
        ...
        color: "text-blue-600",
        subCategories: [
          { id: "allopathic-medicines", name: "Allopathic Medicines", description: "Modern pharmaceutical medicines" },
          { id: "ayurvedic-medicines", name: "Ayurvedic Medicines", description: "Traditional Ayurvedic formulations" },
          {
            id: "medicine-categories",
            name: "Medicine Categories",
            description: "Therapeutic categories for medicines",
          },
          { id: "manufacturers", name: "Manufacturers", description: "Medicine manufacturers and suppliers" },
        ],
      },
      {
        ...
        color: "text-purple-600",
        subCategories: [
          { id: "dosage-patterns", name: "Dosage Patterns", description: "Standard dosage timing patterns" },
          { id: "timing-instructions", name: "Timing Instructions", description: "When to take medicines" },
          { id: "duration-options", name: "Duration Options", description: "Standard treatment duration options" },
          {
      ...
      },
      {
        ...
        color: "text-green-600",
        subCategories: [
          { id: "herbs", name: "Herbs & Ingredients", description: "Individual Ayurvedic herbs and ingredients" },
          {
            id: "classical-formulations",
            name: "Classical Formulations",
            description: "Traditional Ayurvedic formulations",
          },
          { id: "pathya-apathya", name: "Pathya-Apathya", description: "Do's and Don'ts in Ayurvedic treatment" },
        ],
      },
      {
        ...
        subCategories: [
          { id: "ayurvedic-templates", name: "Ayurvedic Templates", description: "Ayurvedic prescription templates" },
          {
        ...
        <div key={section.id} className="space-y-2">
          ...
          <div className="space-y-1">
            {section.categories.map((category) => {
              ...
              const isImplemented = section.id === "master-data" || section.id === "prescription-masters" // Only master data and prescription masters are implemented
